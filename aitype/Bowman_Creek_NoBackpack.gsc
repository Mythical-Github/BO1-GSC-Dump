...
/*QUAKED actor_Bowman_Creek_NoBackpack (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_jungmar_wet_bowman_nobackpack::main();
}
...
precache()
{
	character\c_usa_jungmar_wet_bowman_nobackpack::precache();
