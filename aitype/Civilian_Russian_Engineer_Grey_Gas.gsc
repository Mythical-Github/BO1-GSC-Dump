...
/*QUAKED actor_Civilian_Russian_Engineer_Grey_Gas (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_rus_engineer1_grey_nohelm_gas::main();
}
...
precache()
{
	character\c_rus_engineer1_grey_nohelm_gas::precache();
