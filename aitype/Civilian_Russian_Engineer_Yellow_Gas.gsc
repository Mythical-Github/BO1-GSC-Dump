...
/*QUAKED actor_Civilian_Russian_Engineer_Yellow_Gas (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_rus_engineer1_yellow_nohelm_gas::main();
}
...
precache()
{
	character\c_rus_engineer1_yellow_nohelm_gas::precache();
