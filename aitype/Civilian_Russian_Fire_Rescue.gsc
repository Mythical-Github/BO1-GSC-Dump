...
/*QUAKED actor_Civilian_Russian_Fire_Rescue (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_fire_rescue_fb"
...
main()
{
	...
	character\c_rus_fire_rescue::main();
}
...
precache()
{
	character\c_rus_fire_rescue::precache();
