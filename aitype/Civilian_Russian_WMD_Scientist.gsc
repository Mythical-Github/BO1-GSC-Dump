...
/*QUAKED actor_Civilian_Russian_WMD_Scientist (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_scientist1_fb"
...
main()
{
	...
	character\c_rus_scientist1::main();
}
...
precache()
{
	character\c_rus_scientist1::precache();
