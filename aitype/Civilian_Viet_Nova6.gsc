...
/*QUAKED actor_Civilian_Viet_Nova6 (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_vtn_nova_gassed_civ::main();
}
...
precache()
{
	character\c_vtn_nova_gassed_civ::precache();
