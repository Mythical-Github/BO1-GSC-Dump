...
/*QUAKED actor_Dragovich_burnt_Flashpoint (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_dragovich_old_fb"
...
main()
{
	...
	character\c_rus_dragovich_burnt::main();
}
...
precache()
{
	character\c_rus_dragovich_burnt::precache();
