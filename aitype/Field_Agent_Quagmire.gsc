...
/*QUAKED actor_Field_Agent_Quagmire (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_jungmar_fieldagent_fb"
...
main()
{
	...
	character\c_usa_jungmar_fieldagent::main();
}
...
precache()
{
	character\c_usa_jungmar_fieldagent::precache();
