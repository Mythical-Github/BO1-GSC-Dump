...
/*QUAKED actor_Hudson_Creek (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_jungmar_wet_assault_fb"
...
main()
{
	...
	character\c_usa_jungmar_wet_smg::main();
}
...
precache()
{
	character\c_usa_jungmar_wet_smg::precache();
