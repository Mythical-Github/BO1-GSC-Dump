...
/*QUAKED actor_NVA_e_Flamethrower (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "m2_flamethrower_sp";
	...
	{
	case 0:
		character\c_vtn_nva1_flamethrower::main();
		break;
	case 1:
		character\c_vtn_nva2_flamethrower::main();
		break;
	case 2:
		character\c_vtn_nva3_flamethrower::main();
		break;
	}
}
...
precache()
{
	character\c_vtn_nva1_flamethrower::precache();
	character\c_vtn_nva2_flamethrower::precache();
	character\c_vtn_nva3_flamethrower::precache();
