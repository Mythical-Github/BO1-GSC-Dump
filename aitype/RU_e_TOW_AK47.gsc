...
/*QUAKED actor_RU_e_TOW_AK47 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "uwb_m220_tow_ai_sp";
...
precache()
{
	...
	precacheItem("uwb_m220_tow_ai_sp");
