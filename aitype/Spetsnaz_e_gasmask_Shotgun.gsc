...
/*QUAKED actor_Spetsnaz_e_gasmask_Shotgun (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_rus_spetznaz_1_gasmask::main();
		break;
	case 1:
		character\c_rus_spetznaz_2_gasmask::main();
		break;
	}
}
...
precache()
{
	character\c_rus_spetznaz_1_gasmask::precache();
	character\c_rus_spetznaz_2_gasmask::precache();
