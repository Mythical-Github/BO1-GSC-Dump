...
/*QUAKED actor_TEMP_RU_e_M202 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_general1_fb"
...
precache()
{
	character\c_rus_general1::precache();

	precacheItem("m202_flash_sp");
