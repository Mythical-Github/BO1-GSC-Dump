...
/*QUAKED actor_TEMP_a_barnes_nogear (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\char_h_frank_barnes_tension_nogear::main();
}
...
precache()
{
	character\char_h_frank_barnes_tension_nogear::precache();
