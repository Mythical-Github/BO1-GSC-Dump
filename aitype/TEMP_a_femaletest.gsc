...
/*QUAKED actor_TEMP_a_femaletest (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="char_femaletest_fb"
...
main()
{
	...
	character\char_femaletest::main();
}
...
precache()
{
	character\char_femaletest::precache();
