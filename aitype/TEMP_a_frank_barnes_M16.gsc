...
/*QUAKED actor_TEMP_a_frank_barnes_M16 (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_marine_barnes_fb"
...
main()
{
	...
	character\c_usa_marine_frank_barnes::main();
}
...
precache()
{
	character\c_usa_marine_frank_barnes::precache();
