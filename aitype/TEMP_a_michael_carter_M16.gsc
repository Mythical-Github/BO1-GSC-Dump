...
/*QUAKED actor_TEMP_a_michael_carter_M16 (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_marine_carter_fb"
...
main()
{
	...
	character\c_usa_marine_michael_carter::main();
}
...
precache()
{
	character\c_usa_marine_michael_carter::precache();
