...
/*QUAKED actor_TEMP_a_pete_MP5 (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_sprint1_marine_pete::main();
}
...
precache()
{
	character\c_sprint1_marine_pete::precache();
