...
/*QUAKED actor_TEMP_a_vignette_test (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="char_jeremy_head_test"
...
main()
{
	...
	character\char_h_jeremy_head_test::main();
}
...
precache()
{
	character\char_h_jeremy_head_test::precache();
