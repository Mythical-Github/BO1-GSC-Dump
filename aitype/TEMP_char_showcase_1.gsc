...
/*QUAKED actor_TEMP_char_showcase_1 (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_rus_reznov_captive::main();
		break;
	case 1:
		character\c_rus_reznov_combat::main();
		break;
	}
}
...
precache()
{
	character\c_rus_reznov_captive::precache();
	character\c_rus_reznov_combat::precache();
