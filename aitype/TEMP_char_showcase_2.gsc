...
/*QUAKED actor_TEMP_char_showcase_2 (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_usa_jungmar_bowman::main();
		break;
	case 1:
		character\c_usa_jungmar_wet_bowman::main();
		break;
	}
}
...
precache()
{
	character\c_usa_jungmar_bowman::precache();
	character\c_usa_jungmar_wet_bowman::precache();
