...
/*QUAKED actor_TEMP_char_showcase_3 (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	case 1:
		...
		break;
	case 2:
		character\c_usa_jungmar_barnes_prisoner::main();
		break;
	}
}
...
precache()
{
	...
	character\c_usa_jungmar_barnes_prisoner::precache();
