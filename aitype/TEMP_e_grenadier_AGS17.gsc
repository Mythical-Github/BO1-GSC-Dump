...
/*QUAKED actor_TEMP_e_grenadier_AGS17 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\char_inc_grenadier::main();
}
...
precache()
{
	character\char_inc_grenadier::precache();
