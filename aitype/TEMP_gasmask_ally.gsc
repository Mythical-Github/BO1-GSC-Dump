...
/*QUAKED actor_TEMP_gasmask_ally (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_sprint1_marine_mike_fb"
...
main()
{
	...
	character\char_inc_usa_gasmask_off::main();
}
...
precache()
{
	character\char_inc_usa_gasmask_off::precache();
