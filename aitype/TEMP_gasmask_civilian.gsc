...
/*QUAKED actor_TEMP_gasmask_civilian (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_sprint1_marine_mike_fb_incub"
...
main()
{
	...
	character\c_sprint1_marine_mike_incub::main();
}
...
precache()
{
	character\c_sprint1_marine_mike_incub::precache();
