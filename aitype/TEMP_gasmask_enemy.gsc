...
/*QUAKED actor_TEMP_gasmask_enemy (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_vtn_nva1_fb"
...
main()
{
	...
	character\char_inc_vtn_gasmask_on::main();
}
...
precache()
{
	character\char_inc_vtn_gasmask_on::precache();
