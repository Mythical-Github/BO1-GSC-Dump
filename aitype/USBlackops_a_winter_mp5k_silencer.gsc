...
main()
{
	...
	{
	case 0:
		character\c_usa_blackops_winter_body1::main();
		break;
	case 1:
		character\c_usa_blackops_winter_body2::main();
		break;
	case 2:
		character\c_usa_blackops_winter_body3::main();
		break;
	}
}
...
precache()
{
	character\c_usa_blackops_winter_body1::precache();
	character\c_usa_blackops_winter_body2::precache();
	character\c_usa_blackops_winter_body3::precache();
