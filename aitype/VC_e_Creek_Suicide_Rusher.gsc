...
/*QUAKED actor_VC_e_Creek_Suicide_Rusher (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self setEngagementMinDist( 250.000000, 500.000000 );
	self setEngagementMaxDist( 700.000000, 1500.000000 );

	character\c_vtn_vc3_bleed::main();
}
...
precache()
{
	character\c_vtn_vc3_bleed::precache();
