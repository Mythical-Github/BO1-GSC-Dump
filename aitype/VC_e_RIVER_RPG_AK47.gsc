...
/*QUAKED actor_VC_e_RIVER_RPG_AK47 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "rpg_river_infantry_sp";
...
precache()
{
	...
	precacheItem("rpg_river_infantry_sp");
