...
/*QUAKED actor_mp_ciawin_standard (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_ciawin_mp_body_standard_demo"
...
main()
{
	...
	character\c_ciawin_standard::main();
}
...
precache()
{
	character\c_ciawin_standard::precache();
