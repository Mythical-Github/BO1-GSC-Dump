...
/*QUAKED actor_mp_rus_utility (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_spet_mp_body_utility_demo"
...
precache()
{
	character\c_rus_utility::precache();
