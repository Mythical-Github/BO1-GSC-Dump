...
/*QUAKED actor_mp_ruswin_utility (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_spetwin_mp_body_utility_demo"
...
main()
{
	...
	character\c_ruswin_utility::main();
}
...
precache()
{
	character\c_ruswin_utility::precache();
