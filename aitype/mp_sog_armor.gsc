...
/*QUAKED actor_mp_sog_armor (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_sog_mp_body_armor_demo"
...
precache()
{
	character\c_sog_armor::precache();
