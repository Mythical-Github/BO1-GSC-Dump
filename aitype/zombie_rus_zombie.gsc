...
/*QUAKED actor_zombie_rus_zombie (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\char_rus_r_zombie::main();
}
...
precache()
{
	character\char_rus_r_zombie::precache();
